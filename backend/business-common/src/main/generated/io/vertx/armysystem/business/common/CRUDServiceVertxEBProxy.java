...
public class CRUDServiceVertxEBProxy implements CRUDService {
  ...
  public CRUDServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public CRUDServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;

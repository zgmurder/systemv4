...
public class TrainerLevelConverter {
  ...
  public static void fromJson(Iterable<java.util.Map.Entry<String, Object>> json, TrainerLevel obj) {
  ...
  public static void toJson(TrainerLevel obj, java.util.Map<String, Object> json) {
    if (obj.getId() != null) {

...
/**
 * Converter for {@link io.vertx.armysystem.business.common.standard.rule.TroopAnnualScoreRule}.
 * NOTE: This class has been automatically generated from the {@link io.vertx.armysystem.business.common.standard.rule.TroopAnnualScoreRule} original class using Vert.x codegen.
 */
public class TroopAnnualScoreRuleConverter {

  public static void fromJson(Iterable<java.util.Map.Entry<String, Object>> json, TroopAnnualScoreRule obj) {
  ...
  public static void toJson(TroopAnnualScoreRule obj, JsonObject json) {
    toJson(obj, json.getMap());
  }

  public static void toJson(TroopAnnualScoreRule obj, java.util.Map<String, Object> json) {

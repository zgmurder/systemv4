...
/**
 * Converter for {@link io.vertx.armysystem.business.common.standard.rule.UnitForceAnnualScoreRule}.
 * NOTE: This class has been automatically generated from the {@link io.vertx.armysystem.business.common.standard.rule.UnitForceAnnualScoreRule} original class using Vert.x codegen.
 */
public class UnitForceAnnualScoreRuleConverter {

  public static void fromJson(Iterable<java.util.Map.Entry<String, Object>> json, UnitForceAnnualScoreRule obj) {
  ...
  public static void toJson(UnitForceAnnualScoreRule obj, JsonObject json) {
    toJson(obj, json.getMap());
  }

  public static void toJson(UnitForceAnnualScoreRule obj, java.util.Map<String, Object> json) {

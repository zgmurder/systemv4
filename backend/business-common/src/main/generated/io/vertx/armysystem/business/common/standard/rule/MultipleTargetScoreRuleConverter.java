...
/**
 * Converter for {@link io.vertx.armysystem.business.common.standard.rule.MultipleTargetScoreRule}.
 * NOTE: This class has been automatically generated from the {@link io.vertx.armysystem.business.common.standard.rule.MultipleTargetScoreRule} original class using Vert.x codegen.
 */
public class MultipleTargetScoreRuleConverter {

  public static void fromJson(Iterable<java.util.Map.Entry<String, Object>> json, MultipleTargetScoreRule obj) {
  ...
  public static void toJson(MultipleTargetScoreRule obj, JsonObject json) {
    toJson(obj, json.getMap());
  }

  public static void toJson(MultipleTargetScoreRule obj, java.util.Map<String, Object> json) {

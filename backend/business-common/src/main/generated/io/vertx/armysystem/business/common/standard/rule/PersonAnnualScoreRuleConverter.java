...
/**
 * Converter for {@link io.vertx.armysystem.business.common.standard.rule.PersonAnnualScoreRule}.
 * NOTE: This class has been automatically generated from the {@link io.vertx.armysystem.business.common.standard.rule.PersonAnnualScoreRule} original class using Vert.x codegen.
 */
public class PersonAnnualScoreRuleConverter {

  public static void fromJson(Iterable<java.util.Map.Entry<String, Object>> json, PersonAnnualScoreRule obj) {
  ...
  public static void toJson(PersonAnnualScoreRule obj, JsonObject json) {
    toJson(obj, json.getMap());
  }

  public static void toJson(PersonAnnualScoreRule obj, java.util.Map<String, Object> json) {

...
/**
 * Converter for {@link io.vertx.armysystem.business.common.standard.rule.OrgSingleCourseScoreRule}.
 * NOTE: This class has been automatically generated from the {@link io.vertx.armysystem.business.common.standard.rule.OrgSingleCourseScoreRule} original class using Vert.x codegen.
 */
public class OrgSingleCourseScoreRuleConverter {

  public static void fromJson(Iterable<java.util.Map.Entry<String, Object>> json, OrgSingleCourseScoreRule obj) {
  ...
  public static void toJson(OrgSingleCourseScoreRule obj, JsonObject json) {
    toJson(obj, json.getMap());
  }

  public static void toJson(OrgSingleCourseScoreRule obj, java.util.Map<String, Object> json) {

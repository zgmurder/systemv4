...
public class SoldierServiceVertxProxyHandler extends ProxyHandler {
  ...
  public SoldierServiceVertxProxyHandler(Vertx vertx, SoldierService service){
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public SoldierServiceVertxProxyHandler(Vertx vertx, SoldierService service, long timeoutInSecond){
    this(vertx, service, true, timeoutInSecond);
  }

  public SoldierServiceVertxProxyHandler(Vertx vertx, SoldierService service, boolean topLevel, long timeoutSeconds) {
      this.vertx = vertx;
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        ...
        case "change": {
          service.change((java.lang.String)json.getValue("id"),
                        (io.vertx.core.json.JsonObject)json.getValue("item"),
                        (io.vertx.core.json.JsonObject)json.getValue("principal"),
                        HelperUtils.createHandler(msg));
          break;
        ...
        case "retrieveArchives": {
          service.retrieveArchives((java.lang.String)json.getValue("cardId"),
                        (io.vertx.core.json.JsonObject)json.getValue("principal"),
                        HelperUtils.createListHandler(msg));
          break;
        }

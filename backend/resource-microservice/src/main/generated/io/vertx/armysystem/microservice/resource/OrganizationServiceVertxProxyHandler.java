...
public class OrganizationServiceVertxProxyHandler extends ProxyHandler {
  ...
  public OrganizationServiceVertxProxyHandler(Vertx vertx, OrganizationService service){
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public OrganizationServiceVertxProxyHandler(Vertx vertx, OrganizationService service, long timeoutInSecond){
    this(vertx, service, true, timeoutInSecond);
  }

  public OrganizationServiceVertxProxyHandler(Vertx vertx, OrganizationService service, boolean topLevel, long timeoutSeconds) {
      this.vertx = vertx;
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        ...
        case "swapPosition": {
          service.swapPosition((java.lang.String)json.getValue("id"),
                        (java.lang.String)json.getValue("otherId"),
                        (io.vertx.core.json.JsonObject)json.getValue("principal"),
                        HelperUtils.createHandler(msg));
          break;
        }
        case "deactivate": {
          service.deactivate((java.lang.String)json.getValue("id"),
                        (java.lang.Boolean)json.getValue("deactivated"),
                        (io.vertx.core.json.JsonObject)json.getValue("principal"),
                        HelperUtils.createHandler(msg));
          break;
        }

  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "swapPosition": {
          service.swapPosition((java.lang.String)json.getValue("id"), (java.lang.String)json.getValue("otherId"), (io.vertx.core.json.JsonObject)json.getValue("principal"), createHandler(msg));
          break;
        }
        default: {

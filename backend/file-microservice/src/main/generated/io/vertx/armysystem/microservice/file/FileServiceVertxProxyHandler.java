...
public class FileServiceVertxProxyHandler extends ProxyHandler {
  ...
  public FileServiceVertxProxyHandler(Vertx vertx, FileService service){
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public FileServiceVertxProxyHandler(Vertx vertx, FileService service, long timeoutInSecond){
    this(vertx, service, true, timeoutInSecond);
  }

  public FileServiceVertxProxyHandler(Vertx vertx, FileService service, boolean topLevel, long timeoutSeconds) {
      this.vertx = vertx;

...
public class FileServiceVertxEBProxy implements FileService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public FileServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public FileServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;

...
public class VertxExtensionModule extends ExtensionModule {
  private static final String extensionClasses = "io.vertx.armysystem.microservice.file.groovy.FileService_GroovyExtension";
  private static final String staticExtensionClasses = "";
  private final ExtensionModule delegate;  public VertxExtensionModule() {
    super("io.vertx.armysystem.microservice.file", "3.5.0");
    Properties props = new Properties();
    props.put("moduleName", "io.vertx.armysystem.microservice.file");

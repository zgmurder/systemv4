...
public class RoleServiceVertxEBProxy implements RoleService {
  ...
  public RoleServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public RoleServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public RoleService addRole(Role role, Handler<AsyncResult<Role>> resultHandler) {
    ...
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        ...
        resultHandler.handle(Future.succeededFuture(res.result().body() == null ? null : new Role(res.result().body())));
                      }
    });
    return this;
  }
  ...
  public RoleService retrieveByRoleName(String roleName, Handler<AsyncResult<Role>> resultHandler) {
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "retrieveByRoleName");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public RoleService retrieveAllRoles(Handler<AsyncResult<List<Role>>> resultHandler) {
    ...
    _vertx.eventBus().<JsonArray>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        ...
        resultHandler.handle(Future.succeededFuture(res.result().body().stream().map(o -> o instanceof Map ? new Role(new JsonObject((Map) o)) : new Role((JsonObject) o)).collect(Collectors.toList())));
      }
    });
    return this;
  }
  ...
  public RoleService retrieveRolesByCondition(JsonObject condition, Handler<AsyncResult<List<Role>>> resultHandler) {
    ...
    _json.put("condition", condition);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "retrieveRolesByCondition");
    _vertx.eventBus().<JsonArray>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {

  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        ...
        case "loginUser": {
          service.loginUser((java.lang.String)json.getValue("username"),
                        (java.lang.String)json.getValue("password"),
                        HelperUtils.createHandler(msg));
          break;
        }
        case "updatePassword": {
          service.updatePassword((java.lang.String)json.getValue("username"),
                        (java.lang.String)json.getValue("oldPassword"),
                        (java.lang.String)json.getValue("newPassword"),
                        HelperUtils.createHandler(msg));
          break;
        }

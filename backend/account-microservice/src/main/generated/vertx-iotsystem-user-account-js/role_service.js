...
/** @module vertx-iotsystem-user-account-js/role_service */
var utils = require('vertx-js/util/utils');

var io = Packages.io;
var JsonObject = io.vertx.core.json.JsonObject;
var JRoleService = Java.type('io.vertx.iotsystem.microservice.account.RoleService');
var Role = Java.type('io.vertx.iotsystem.microservice.account.Role');
...
var RoleService = function(j_val) {
  ...
  this.addRole = function(role, resultHandler) {
    ...
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_roleService["addRole(io.vertx.iotsystem.microservice.account.Role,io.vertx.core.Handler)"](role != null ? new Role(new JsonObject(Java.asJSONCompatible(role))) : null, function(ar) {
      if (ar.succeeded()) {
  ...
  this.count = function(query, resultHandler) {
    var __args = arguments;
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_roleService["count(io.vertx.core.json.JsonObject,io.vertx.core.Handler)"](utils.convParamJsonObject(query), function(ar) {
      if (ar.succeeded()) {
  ...
  /**
   ...
   @return {RoleService}
   */
  this.retrieveRolesByCondition = function(query, findOptions, resultHandler) {
    var __args = arguments;
    if (__args.length === 3 && (typeof __args[0] === 'object' && __args[0] != null) && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
      j_roleService["retrieveRolesByCondition(io.vertx.core.json.JsonObject,io.vertx.core.json.JsonObject,io.vertx.core.Handler)"](utils.convParamJsonObject(query), utils.convParamJsonObject(findOptions), function(ar) {
      if (ar.succeeded()) {
        resultHandler(utils.convReturnListSetDataObject(ar.result()), null);
      } else {
        resultHandler(null, ar.cause());
  ...
  this.updateRole = function(role, resultHandler) {
    var __args = arguments;
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_roleService["updateRole(io.vertx.iotsystem.microservice.account.Role,io.vertx.core.Handler)"](role != null ? new Role(new JsonObject(Java.asJSONCompatible(role))) : null, function(ar) {
      if (ar.succeeded()) {
        resultHandler(utils.convReturnDataObject(ar.result()), null);
      } else {
        resultHandler(null, ar.cause());
...
RoleService._jclass = utils.getJavaClass("io.vertx.iotsystem.microservice.account.RoleService");
RoleService._jtype = {
  accept: function(obj) {

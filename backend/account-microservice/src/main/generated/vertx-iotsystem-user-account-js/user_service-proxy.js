...
!function (factory) {
  if (typeof require === 'function' && typeof module !== 'undefined') {
    ...
    // AMD loader
    define('vertx-iotsystem-user-account-js/user_service-proxy', [], factory);
  } else {
    // plain old include
    UserService = factory();
  }
  ...
  var UserService = function(eb, address) {
    ...
    this.count = function(query, principal, resultHandler) {
      ...
      if (__args.length === 3 && (typeof __args[0] === 'object' && __args[0] != null) && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
        ...
        j_eb.send(j_address, {"query":__args[0], "principal":__args[1]}, {"action":"count"}, function(err, result) { __args[2](err, result &&result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.retrieveUsersByCondition = function(query, findOptions, principal, resultHandler) {
      ...
      if (__args.length === 4 && (typeof __args[0] === 'object' && __args[0] != null) && (typeof __args[1] === 'object' && __args[1] != null) && (typeof __args[2] === 'object' && __args[2] != null) && typeof __args[3] === 'function') {
        ...
        j_eb.send(j_address, {"query":__args[0], "findOptions":__args[1], "principal":__args[2]}, {"action":"retrieveUsersByCondition"}, function(err, result) { __args[3](err, result &&result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };

...
!function (factory) {
  if (typeof require === 'function' && typeof module !== 'undefined') {
    ...
    // AMD loader
    define('vertx-iotsystem-user-account-js/role_service-proxy', [], factory);
  } else {
    // plain old include
    RoleService = factory();
  }
  ...
  var RoleService = function(eb, address) {
    ...
    this.count = function(query, resultHandler) {
      ...
      if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"query":__args[0]}, {"action":"count"}, function(err, result) { __args[1](err, result &&result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.retrieveRolesByCondition = function(query, findOptions, resultHandler) {
      ...
      if (__args.length === 3 && (typeof __args[0] === 'object' && __args[0] != null) && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
        ...
        j_eb.send(j_address, {"query":__args[0], "findOptions":__args[1]}, {"action":"retrieveRolesByCondition"}, function(err, result) { __args[2](err, result &&result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };

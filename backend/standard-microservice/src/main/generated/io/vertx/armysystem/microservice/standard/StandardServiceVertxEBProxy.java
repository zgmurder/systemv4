...
public class StandardServiceVertxEBProxy implements StandardService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public StandardServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public StandardServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  StandardService activateStandard(String id, JsonObject item, JsonObject principal, Handler<AsyncResult<JsonObject>> resultHandler){
    ...
    _deliveryOptions.addHeader("action", "activateStandard");

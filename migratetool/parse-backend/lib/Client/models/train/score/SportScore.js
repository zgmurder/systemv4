...
//  sportEvent: { type: Schema.Types.ObjectId, ref: 'AssessEvent' },        // 体育课目考核事件 -- 已废弃
...
//  untestedReason: String                                                  // 未参考原因
// });

const SportScore = Parse.Object.extend("SportScoreV2", {
    ...
    getIncludes: function() {
        return ['organization', 'displayOrg', 'organizer', 'soldier', 'course', 'assessEvent'];
    }
});

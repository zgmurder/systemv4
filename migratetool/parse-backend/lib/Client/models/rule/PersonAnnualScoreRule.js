...
// 个人年度训练成绩评定标准
// const PersonAnnualScoreRuleSchema = new Schema({
...
const PersonAnnualScoreRule = Parse.Object.extend("PersonAnnualScoreRule", {
    // Instance properties go in an initialize method
    initialize: function (attrs, options) { }
}, {
        // Class methods
        fromObject: function (obj) {
            var item = new PersonAnnualScoreRule();
...
module.exports = PersonAnnualScoreRule;
...
// 多对象综合训练成绩评定标准
// const MultipleTargetScoreRuleSchema = new Schema({
...
const MultipleTargetScoreRule = Parse.Object.extend("MultipleTargetScoreRule", {
    // Instance properties go in an initialize method
    initialize: function (attrs, options) { }
}, {
        // Class methods
        fromObject: function (obj) {
            var item = new MultipleTargetScoreRule();
...
module.exports = MultipleTargetScoreRule;
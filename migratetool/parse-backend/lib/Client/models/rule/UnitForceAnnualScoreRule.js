...
// 分队年度训练成绩评定标准
// const UnitForceAnnualScoreRuleSchema = new Schema({
...
const UnitForceAnnualScoreRule = Parse.Object.extend("UnitForceAnnualScoreRule", {
    // Instance properties go in an initialize method
    initialize: function (attrs, options) { }
}, {
        // Class methods
        fromObject: function (obj) {
            var item = new UnitForceAnnualScoreRule();
...
module.exports = UnitForceAnnualScoreRule;
...
// 部队年度训练成绩评定标准
// const TroopAnnualScoreRuleSchema = new Schema({
...
const TroopAnnualScoreRule = Parse.Object.extend("TroopAnnualScoreRule", {
    // Instance properties go in an initialize method
    initialize: function (attrs, options) { }
}, {
        // Class methods
        fromObject: function (obj) {
            var item = new TroopAnnualScoreRule();
...
module.exports = TroopAnnualScoreRule;
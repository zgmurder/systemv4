...
// 单位多课目训练成绩评定规则
// const OrgMultipleCourseScoreRuleSchema = new Schema({
...
const OrgMultipleCourseScoreRule = Parse.Object.extend("OrgMultipleCourseScoreRule", {
    // Instance properties go in an initialize method
    initialize: function (attrs, options) { }
}, {
        // Class methods
        fromObject: function (obj) {
            var item = new OrgMultipleCourseScoreRule();
...
module.exports = OrgMultipleCourseScoreRule;
...
const TrainCourse = Parse.Object.extend("Course", {
    // Instance properties go in an initialize method
    initialize: function (attrs, options) {
        this.set('category', CourseCategory.Train);
        this.set('isManual', false);
    }
}, {
        // Class methods
        fromObject: function (obj) {
            var item = new TrainCourse();
        ...
        queryCondition: function (query) {
            query.equalTo('category', CourseCategory.Train);
        },

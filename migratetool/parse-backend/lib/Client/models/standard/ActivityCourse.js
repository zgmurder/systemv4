...
const ActivityCourse = Parse.Object.extend("Course", {
    // Instance properties go in an initialize method
    initialize: function (attrs, options) {
        this.set('category', CourseCategory.Activity);
        this.set('isManual', true);
    }
}, {
        // Class methods
        fromObject: function (obj) {
            var item = new ActivityCourse();
        ...
        queryCondition: function (query) {
            query.equalTo('category', CourseCategory.Activity);
        },
    });

module.exports = ActivityCourse;

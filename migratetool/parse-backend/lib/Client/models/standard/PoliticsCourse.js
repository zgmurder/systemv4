...
const PoliticsCourse = Parse.Object.extend("Course", {
    // Instance properties go in an initialize method
    initialize: function (attrs, options) {
        this.set('category', CourseCategory.Politics);
        this.set('isManual', true);
    }
}, {
        // Class methods
        fromObject: function (obj) {
            var item = new PoliticsCourse();
        ...
        queryCondition: function (query) {
            query.equalTo('category', CourseCategory.Politics);
        },
    });

module.exports = PoliticsCourse;
